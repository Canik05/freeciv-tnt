...
artists = "
    Canik [CK] <www.tacticsandtriumph.com>
    Lexxie9952 [Lexxie]
    Alex Mor [Alex]
...
tiles = { "row", "column", "tag"
  ...
  0,  0, "u.armor"	  	; [Nemo] & [Canik]
  0,  1, "u.howitzer"		; [Nemo] & [Canik]--fallback: u_howitzer_o is in units_oversize.spec<<FCW:remove this line if sprite sheet building fails
  0,  2, "u.battleship"	; [Lexxie]
  0,  3, "u.bomber"		  ; [GB]
  0,  4, "u.cannon"		  ; [Canik]
  0,  5, "u.caravan"		; [Alex] & [CT]
  0,  6, "u.carrier"		; [Nemo] & [Canik]
  0,  7, "u.catapult"		; [Canik]
  0,  8, "u.horsemen"		; [GB] & [Canik]
  0,  9, "u.chariot"		; [BB] & [GB] & [Canik]
  0, 10, "u.cruiser"		; [Nemo] & [Canik]
  0, 11, "u.diplomat"		; [Nemo] & [Canik]
  0, 12, "u.fighter"		; [Canik]
  0, 13, "u.frigate"		; [BB]
  0, 14, "u.ironclad"		; [Nemo] & [Canik]
  0, 15, "u.knights"		; [BB] & [Canik]
  0, 16, "u.legion"		   ; [GB] & [Canik]
  0, 17, "u.mech_inf"		; [GB] & [Canik]
  0, 18, "u.warriors"		; [GB] & [Lexxie]
  0, 19, "u.musketeers" ; [Canik]
  1,  0, "u.nuclear"		; [Nemo] & [CS] & [Lexxie]
  1,  1, "u.phalanx"		; [Lexxie]
  1,  2, "u.riflemen"		; [Canik]
  1,  3, "u.caravel"		; [Canik]
  1,  4, "u.settlers"		; [MHN] & [Canik]
  1,  5, "u.submarine"	; [GP] & [Lexxie]
  1,  6, "u.transport"	; [Nemo] & [Lexxie]
  1,  7, "u.trireme"		; [BB]
  1,  8, "u.archers"		; [GB] & [Canik]
  1,  9, "u.cavalry"		; [Canik]
  1, 10, "u.cruise_missile"	; [Canik]
  1, 11, "u.destroyer"	  	; [Nemo] & [Canik]
  1, 12, "u.dragoons"		    ; [GB] & [Canik]
  1, 13, "u.explorer"		    ; [Alex] & [CT] & [Canik]
  1, 14, "u.freight"		    ; [CT] & qwm & [Lexxie] - This new graphic is NOT MP2_C onward, Freight unit.
  1, 15, "u.galleon"		    ; [BB]
  1, 16, "u.partisan"		    ; [BB] & [CT] & [Canik]
  1, 17, "u.pikemen"		    ; [T] & [Canik]
  1, 18, "u.escort_fighter" ; [Lexxie]
  1, 19, "u.medium_bomber"  ; [Canik]
  2,  0, "u.marines"		    ; [GB] & [Canik]
  2,  1, "u.amphorae"       ; [Lexxie]
  2,  2, "u.engineers"		  ; [Nemo] & [CT] & [Canik]
  2,  3, "u.artillery"	   	; [Canik]
  2,  4, "u.helicopter"		  ; [T] & [Canik]
  2,  5, "u.alpine_troops"	; [Nemo] & [Canik]
  2,  6, "u.stealth_bomber"	; [GB] & [Canik]
  2,  7, "u.stealth_fighter"; [Canik]
  2,  8, "u.aegis_cruiser"	; [GP] & [Canik]
  2,  9, "u.paratroopers"	  ; [Alex] & [Canik]
  2, 10, "u.elephants"		  ; [Alex] & [GG] & [CT] & [Canik]
  2, 11, "u.crusaders"	  	; [BB]
  2, 12, "u.fanatics"		    ; [GB] & [CT] & [Canik]
  2, 13, "u.awacs"		      ; [Canik]
  2, 14, "u.worker"		      ; [GB]
  2, 15, "u.leader"		      ; [GB]
  2, 16, "u.barbarian_leader"	; FiftyNine
  2, 17, "u.migrants"		    ; Eleazar
  2, 18, "u.anti_aircraft"    ; [Lexxie] & [Canik]
  2, 19, "u.tribesmen"        ; [Canik]
  3,  0, "u.well_digger"		  ; [Lexxie]
  3,  1, "u.balloon"          ; [Canik]
  3,  2, "u.missile_destroyer" ; [Canik]
  3,  3, "u.war_galley"       ; [Canik]
  3,  4, "u.longboat"         ; Canik
  ...
  3,  7, "u.galley"           ; Canik
  3,  8, "u.jet_fighter"      ; [Nemo] & [AHS] & [Canik]
  3,  9, "u.ram_ship"         ; Lexxie
  3, 10, "u.armor_ii"         ; Wahazar & Canik
  3, 11, "u.boat"             ; Lexxie
  3, 12, "u.cargo_ship"       ; Lexxie
  3, 13, "u.mobile_sam"       ; Canik
  ...
  4,  2, "u.spy"              ; Lexxie
  4,  3, "u.train"            ; Canik
  4,  4, "u.t_helicopter"     ; Canik
  4,  5, "u.airplane"         ; Lexxie
  4,  6, "u.swordsmen"        ; Canik
  4,  7, "u.siege_ram"        ; Canik
