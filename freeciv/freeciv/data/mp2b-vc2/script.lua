    ...
    if game_turn < 15 then
      for c in player:cities_iterate() do 
        if c:has_building(find.building_type("Palace")) then
          ...
          _("<font color=#ffff00>Travellers tell stories of the %s, who ride wild beasts near %s! (%i,%i)</font>"),
...
"))
  ...
  if turn == 2 then
    notify.event(nil, nil, E.SCRIPT,
_("<b>Hunt for Food!</b>\n\
Animal meat is an important part of the Stone Age diet. Use wandering Deer and Wild Boar for extra food.\
