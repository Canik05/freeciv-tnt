...
const EFT_INFRA_POINTS = 120;
const EFT_UNIT_RECOVER_PCT = 121;
const EFT_UNIT_UNHAPPY_COST = 122;
const EFT_PEACEFUL_FIELDUNIT_BONUS = 123;
const EFT_FORTIFY_DEFENSE_BONUS = 124;
const EFT_UNIT_SHIELD_VALUE_PCT = 125;
const EFT_UNIT_WORK_FRAG_BONUS = 126;
const EFT_UNIT_WORK_PCT = 127;
const EFT_COINAGE_BONUS_PM = 128;
const EFT_IMPROVEMENT_SALE_PCT = 129;
const EFT_GULAG = 130;
const EFT_STACK_ESCAPE_PCT = 131;
const EFT_IMPR_BUILD_COST_PM = 132;
const EFT_ACTION_RESIST_PCT = 133;
//___________________
const EFT_LAST = 133;
